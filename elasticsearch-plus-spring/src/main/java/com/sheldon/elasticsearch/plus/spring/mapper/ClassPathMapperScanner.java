...
public class ClassPathMapperScanner extends ClassPathBeanDefinitionScanner {
    ...
    public String getElasticsearchAsyncClientName() {
        return elasticsearchAsyncClientName;
    }

    public void setElasticsearchAsyncClientName(String elasticsearchAsyncClientName) {
        this.elasticsearchAsyncClientName = elasticsearchAsyncClientName;
    }
    ...
    public Set<BeanDefinitionHolder> doScan(String... basePackages) {
        ...
        if (beanDefinitions.isEmpty()) {
            LOGGER.warn(() -> "No ElasticSearch mapper was found in '" + Arrays.toString(basePackages) + "' package. Please check your configuration.");
        } else {
    ...
    private void processBeanDefinitions(Set<BeanDefinitionHolder> beanDefinitions) {
        ...
        for (BeanDefinitionHolder holder : beanDefinitions) {
            ...
            if (StringUtils.hasText(this.elasticsearchAsyncClientName)) {
                definition.getPropertyValues().add("elasticsearchAsyncClient", new RuntimeBeanReference(this.elasticsearchAsyncClientName));
                explicitFactoryUsed = true;
            } else if (this.elasticsearchAsyncClient != null) {
                definition.getPropertyValues().add("elasticsearchAsyncClient", this.elasticsearchAsyncClient);
                explicitFactoryUsed = true;
            }
